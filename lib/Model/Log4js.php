 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Log4js implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'loggers' => '\Swagger\Client\Model\Log4jsWMSLoggerConfig[]',
        'server_name' => 'string',
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['loggers'] === null) {
            $invalidProperties[] = "'loggers' can't be null";
        }
     ...
     * Gets loggers
     *
     * @return \Swagger\Client\Model\Log4jsWMSLoggerConfig[]
     */
     ...
     * Sets loggers
     *
     * @param \Swagger\Client\Model\Log4jsWMSLoggerConfig[] $loggers loggers
     *
     * @return $this
     */
