 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StreamRecordersConfig implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'streamrecorder' => '\Swagger\Client\Model\StreamRecorderConfig[]',
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['streamrecorder'] === null) {
            $invalidProperties[] = "'streamrecorder' can't be null";
        }
     ...
     * Sets streamrecorder
     *
     * @param \Swagger\Client\Model\StreamRecorderConfig[] $streamrecorder streamrecorder
     *
     * @return $this
     */
