 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HostPortsConfig implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'hostports' => '\Swagger\Client\Model\ShortObject[]',
        'server_name' => 'string',
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['hostports'] === null) {
            $invalidProperties[] = "'hostports' can't be null";
        }
     ...
     * Sets hostports
     *
     * @param \Swagger\Client\Model\ShortObject[] $hostports hostports
     *
     * @return $this
     */
