 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PushPublishStreamsAppConfig implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'map_entries' => '\Swagger\Client\Model\PushPublishStreamAppConfig[]',
        'server_name' => 'string',
    ...
    {
        $this->container['map_entries'] = isset($data['map_entries']) ? $data['map_entries'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['map_entries'] === null) {
            $invalidProperties[] = "'map_entries' can't be null";
        }
     ...
     * Sets map_entries
     *
     * @param \Swagger\Client\Model\PushPublishStreamAppConfig[] $map_entries map_entries
     *
     * @return $this
     */
