 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InstancesConfig implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'instance_list' => '\Swagger\Client\Model\InstanceConfig[]',
        'server_name' => 'string',
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['instance_list'] === null) {
            $invalidProperties[] = "'instance_list' can't be null";
        }
     ...
     * Sets instance_list
     *
     * @param \Swagger\Client\Model\InstanceConfig[] $instance_list instance_list
     *
     * @return $this
     */
