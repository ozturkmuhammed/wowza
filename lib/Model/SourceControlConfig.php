 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SourceControlConfig implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['feature_list'] = isset($data['feature_list']) ? $data['feature_list'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['firmware'] === null) {
            $invalidProperties[] = "'firmware' can't be null";
        }
     ...
     * Sets feature_list
     *
     * @param string[] $feature_list feature_list
     *
     * @return $this
     */
     ...
     * Sets firmware
     *
     * @param string $firmware firmware
     *
     * @return $this
     */
