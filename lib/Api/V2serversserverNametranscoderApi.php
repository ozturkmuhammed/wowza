<?php
/**
 * V2serversserverNametranscoderApi
 * PHP version 5
 *
 * @category Class
...
/**
 * V2serversserverNametranscoderApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V2serversserverNametranscoderApi
{
    /**
     * @var ClientInterface
     */
     ...
     */
    public function getTranscoderConfig($server_name)
    {
        list($response) = $this->getTranscoderConfigWithHttpInfo($server_name);
        return $response;
    }
     ...
     */
    public function getTranscoderConfigWithHttpInfo($server_name)
    {
        $returnType = '\Swagger\Client\Model\TranscoderConfig';
        $request = $this->getTranscoderConfigRequest($server_name);
     ...
     */
    public function getTranscoderConfigAsync($server_name)
    {
        return $this->getTranscoderConfigAsyncWithHttpInfo($server_name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTranscoderConfigAsyncWithHttpInfo($server_name)
    {
        $returnType = '\Swagger\Client\Model\TranscoderConfig';
        $request = $this->getTranscoderConfigRequest($server_name);
     ...
     */
    protected function getTranscoderConfigRequest($server_name)
    {
